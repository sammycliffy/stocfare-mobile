...
class _ExpensesHomePageState extends State<IncomeHomePage> {
  ...
  bool _loading = false;
  String _newExpenses;
  Future<ExpensesSummary> _incomeSummary;
  Future<List<GetAllExpenses>> _getallIncome;
  bool today = false;
  bool week = false;
  bool month = false;
    ...
    Subscription().getSubscriptionPlan().then((value) {
      if (value == 'PREMIUM') {
        _activitiesServices.checkForInternet().then((value) {
          if (value == true) {
            _expensesServices.getIncomeDropdown().then((value) {
              setState(() {
              ...
              setState(() {
                ...
                _errorMessage = e.toString() ?? 'An Error Occured';
              });
            });
          } else {
            _isNetwork = false;
                        ...
                        children: [
                          ...
                          Center(
                            child: FutureBuilder<ExpensesSummary>(
                                future: _expensesServices.getIncomeSummary(),
                          ...
                          FutureBuilder<List<GetAllExpenses>>(
                              future: _expensesServices.getAllIncome(),
                              builder: (context, snapshot) {
                                if (snapshot.hasData) {
                                  _expensesName.clear();
                                  ...
                                  return Expanded(
                                    child: ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          controller3.updateValue(double.parse(
                                              _expensesAmount[index]));
                                          return _listTile(
                                              _expensesName[index],
                                ...
                                if (_formKey.currentState.validate()) {
                                  _activitiesServices
                                    ...
                                    if (value == true) {
                                      ...
                                      dynamic result =
                                          await _expensesServices.createIncome(
  ...
  rebuildPage() {
    setState(() {
      _incomeSummary = _expensesServices.getExpenseSummary();
      _getallIncome = _expensesServices.getAllIncome();
    });
  }
