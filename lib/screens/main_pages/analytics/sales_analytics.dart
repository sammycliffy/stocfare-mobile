                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          _checkSales.analyticsDetails('week').then((value) {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => AnalyticsDetailsPage(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      GestureDetector(
                        ...
                        onTap: () {
                          _checkSales.analyticsDetails('month').then((value) {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => AnalyticsDetailsPage(
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          _checkSales.analyticsDetails('quarter').then((value) {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => AnalyticsDetailsPage(
                                        analyticsData: value,
                                        pageTitle: 'Quarter\'s Report')));
                          });
                        },
                      )
                    ],
