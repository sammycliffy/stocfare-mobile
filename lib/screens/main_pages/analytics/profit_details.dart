        ...
        body: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              Text(
                'REF:  ${widget.profitList[widget.productIndex].salesProfitId.refCode}',
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),
              ),
              Text(
                Jiffy(widget.profitList[widget.productIndex].salesProfitId
                        .dateCreated)
                    .yMMMMEEEEdjm,
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text(
                      widget
                          .profitList[widget.productIndex].salesProfitId.change,
                      style: TextStyle(
                        fontSize: 16,
                      ),
                    ),
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    padding: const EdgeInsets.only(right: 30, top: 10),
                    child: Text(
                      widget.profitList[widget.productIndex].salesProfitId
                          .saleRegisteredBy,
                      style: TextStyle(
                        fontSize: 16,
                      ),
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text(
                      widget
                          .profitList[widget.productIndex].salesProfitId.amount,
                      style: TextStyle(
                        fontSize: 16,
                      ),
                    ),
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            padding: const EdgeInsets.only(right: 30, top: 10),
                            child: Text(
                              widget.profitList[widget.productIndex]
                                  .salesProfitId.tax,
                              style: TextStyle(
                                  fontSize: 16,
                                  fontFamily: 'Sora',
